...
describe('expressionsUtils', () => {
  describe('convertSubExpression', () => {
    it('converts first part of external subexpression in array format to internal subexpression where dataSource and dataSourceValue are set', async () => {
    ...
    it('converts comparable part of external subexpression in array format to internal subexpression where compDataSource and compDataSourceValue are set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts first part of external subexpression in string format to internal subexpression where dataSource and dataSourceValue are set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts comparable part of external subexpression in string format to internal subexpression where compDataSource and compDataSourceValue are set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts first part of external subexpression in number format to internal subexpression where dataSource and dataSourceValue are set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts comparable part of external subexpression in number format to internal subexpression where compDataSource and compDataSourceValue are set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts first part of external subexpression as null to internal subexpression where dataSource is set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
    ...
    it('converts comparable part of external subexpression as null to internal subexpression where compDataSource is set', async () => {
      const baseInternalSubExpression: SubExpression = {
        id: 'some-id',
        function: ExpressionFunction.Equals,
      }
