    ...
    public class AppDevelopmentController : Controller
    {
        ...
        public async Task<ActionResult<Dictionary<string, JsonNode>>> GetFormLayouts(string org, string app, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                Dictionary<string, JsonNode> formLayouts = await _appDevelopmentService.GetFormLayouts(new AltinnAppContext(org, app, developer), layoutSetName);
        ...
        public async Task<ActionResult> SaveFormLayout(string org, string app, [FromQuery] string layoutSetName, [FromRoute] string layoutName, [FromBody] JsonNode formLayout)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                await _appDevelopmentService.SaveFormLayout(new AltinnAppContext(org, app, developer), layoutSetName, layoutName, formLayout);
                return Ok();
            }
            catch (FileNotFoundException exception)
            {
        ...
        public ActionResult DeleteFormLayout(string org, string app, [FromQuery] string layoutSetName, [FromRoute] string layoutName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                _appDevelopmentService.DeleteFormLayout(new AltinnAppContext(org, app, developer), layoutSetName, layoutName);
                return Ok();
            }
            catch (FileNotFoundException exception)
            {
        ...
        public ActionResult UpdateFormLayoutName(string org, string app, [FromQuery] string layoutSetName, [FromRoute] string layoutName, [FromBody] string newName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                _appDevelopmentService.UpdateFormLayoutName(new AltinnAppContext(org, app, developer), layoutSetName, layoutName, newName);
                return Ok();
            }
            catch (FileNotFoundException exception)
            {
        ...
        public async Task<ActionResult> SaveLayoutSettings(string org, string app, [FromQuery] string layoutSetName, [FromBody] JsonNode layoutSettings)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                await _appDevelopmentService.SaveLayoutSettings(new AltinnAppContext(org, app, developer), layoutSettings, layoutSetName);
                return Ok();
            }
            catch (FileNotFoundException exception)
            {
        ...
        public async Task<ActionResult<JsonNode>> GetLayoutSettings(string org, string app, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                var layoutSettings = await _appDevelopmentService.GetLayoutSettings(new AltinnAppContext(org, app, developer), layoutSetName);
        ...
        public async Task<ActionResult<JsonNode>> GetLayoutSets(string org, string app)
        {
            ...
            {
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                LayoutSets layoutSets = await _appDevelopmentService.GetLayoutSets(new AltinnAppContext(org, app, developer));
        ...
        public async Task<ActionResult<LayoutSets>> ConfigureLayoutSet(string org, string app, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                LayoutSets layoutSets = await _appDevelopmentService.ConfigureLayoutSet(new AltinnAppContext(org, app, developer), layoutSetName);
                return Ok(layoutSets);
            }
            catch (BadHttpRequestException exception)
            {
        ...
        public async Task<ActionResult> AddLayoutSet(string org, string app, [FromQuery] LayoutSetConfig layoutSet)
        {
            ...
            {
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                await _appDevelopmentService.AddLayoutSet(new AltinnAppContext(org, app, developer), layoutSet);
                return Ok();
            }
            catch (FileNotFoundException exception)
            {
        ...
        public async Task<IActionResult> GetRuleHandler(string org, string app, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                string ruleHandler = await _appDevelopmentService.GetRuleHandler(new AltinnAppContext(org, app, developer), layoutSetName);
        ...
        public async Task<IActionResult> SaveRuleHandler(string org, string app, [FromQuery] string layoutSetName)
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new(Request.Body))
                {
                    ...
                    await _appDevelopmentService.SaveRuleHandler(new AltinnAppContext(org, app, developer), content, layoutSetName);
                }
        ...
        public async Task<IActionResult> SaveRuleConfig(string org, string app, [FromBody] JsonNode ruleConfig, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                await _appDevelopmentService.SaveRuleConfig(new AltinnAppContext(org, app, developer), ruleConfig, layoutSetName);
                return Ok();
            }
        ...
        public async Task<IActionResult> GetRuleConfig(string org, string app, [FromQuery] string layoutSetName)
        {
            try
            {
                ...
                string developer = AuthenticationHelper.GetDeveloperUserName(HttpContext);
                string ruleConfig = await _appDevelopmentService.GetRuleConfigAndAddDataToRootIfNotAlreadyPresent(new AltinnAppContext(org, app, developer), layoutSetName);
