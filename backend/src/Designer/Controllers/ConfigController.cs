...
namespace Altinn.Studio.Designer.Controllers
{
    ...
    public class ConfigController : Controller
    {
        ...
        public async Task SetServiceConfig(string org, string app, [FromBody] dynamic serviceConfig)
        {
            ...
            await _textsService.UpdateTextsForKeys(new AltinnAppContext(org, app, developer), new Dictionary<string, string> { { "appName", serviceConfig.serviceName.ToString() } }, "nb");
