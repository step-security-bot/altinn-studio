...
namespace Altinn.Studio.Designer.Services.Interfaces
{
    ...
    public interface ISchemaModelService
    {
        ...
        IList<AltinnCoreFile> GetSchemaFiles(AltinnAppContext altinnAppContext, bool xsd = false);
        ...
        Task<string> GetSchema(AltinnAppContext altinnAppContext, string relativeFilePath);
        ...
        Task UpdateSchema(AltinnAppContext altinnAppContext, string relativeFilePath, string jsonContent, bool saveOnly = false);
        ...
        /// <param name="relativeFilePath">Relative path to the file.</param>
        /// <param name="jsonContent">The JSON contents of the file.</param>
        Task<string> UpdateModelFilesFromJsonSchema(AltinnAppContext altinnAppContext, string relativeFilePath, string jsonContent);
        ...
        Task<string> BuildSchemaFromXsd(AltinnAppContext altinnAppContext, string modelName, Stream xsdStream);
        ...
        Task<(string RelativePath, string JsonSchema)> CreateSchemaFromTemplate(AltinnAppContext altinnAppContext, string schemaName, string relativeDirectory = "", bool altinn2Compatible = false);
        ...
        /// <param name="altinnAppContext">An <see cref="AltinnAppContext"/></param>
        /// <param name="relativeFilePath">Relative path to the file.</param>
        Task DeleteSchema(AltinnAppContext altinnAppContext, string relativeFilePath);
    }
}
